...
func (tx *Tx) init() {
	tx.BookibusUser = NewBookibusUserClient(tx.config)
	...
	tx.VehicleImage = NewVehicleImageClient(tx.config)
}
...
// applies a query, for example: BookibusUser.QueryXXX(), the query will be executed
