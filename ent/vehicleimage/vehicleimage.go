...
const (
	// Label holds the string label denoting the vehicleimage type in the database.
	Label = "vehicle_image"
	...
	EdgeVehicle = "vehicle"
	// Table holds the table name of the vehicleimage in the database.
	Table = "vehicle_images"
	// VehicleTable is the table that holds the vehicle relation/edge.
	VehicleTable = "vehicle_images"
	...
	VehicleColumn = "vehicle_images"
)

// Columns holds all SQL columns for vehicleimage fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "vehicle_images"
...
// OrderOption defines the ordering options for the VehicleImage queries.
